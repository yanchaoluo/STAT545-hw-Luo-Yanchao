...
I spent many times to finish task 1. And I still do not know how to knit right document to GitHub. If I do not choose html_document, it will show error below. If I decide use html_document, it will have mant messy HTML outputs. Maybe it better to download my document and see the HTML result for task 1.
```
